...
public class ChargexAqueductImpl extends AbstractOpenemsModbusComponent implements Evcs, ElectricityMeter, ChargexAqueduct, ModbusComponent, OpenemsComponent, ManagedEvcs, TimedataProvider, DeprecatedEvcs, EventHandler {
...
//			        m(ChargexAqueduct.ChannelId.ERRORS_CP_MODULE_0, new UnsignedWordElement(0x006E))),
	...
	private void addStatusListener() {
		this.channel(ChargexAqueduct.ChannelId.STATES_CP_MODULE_0).onSetNextValue(s -> {
