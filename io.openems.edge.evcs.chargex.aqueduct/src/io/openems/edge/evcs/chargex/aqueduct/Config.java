...
@ObjectClassDefinition(//
		name = "EVCS ChargeX Aqueduct", //
		description = "Implements the ChargeX Aqueduct Charger")
@interface Config {
	...
	String webconsole_configurationFactory_nameHint() default "EVCS ChargeX Aqueduct [{id}]";
